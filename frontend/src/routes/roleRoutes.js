...
const ROLE_NAVIGATION_ITEMS = {
  Admin: [
    ...
    { label: "Kho hình ảnh/ Video", path: routeConfig.adminProctoringEvidence },
    { label: "AI giám sát", path: routeConfig.adminProctoringAi },
    { label: "Email Gmail", path: routeConfig.adminEmailSettings },
  ...
  Teacher: [
    ...
    { label: "Kho hình ảnh/ Video", path: routeConfig.teacherProctoringEvidence },
