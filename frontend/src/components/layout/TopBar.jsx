    ...
    <header className="eg-shell-panel rounded-[32px] px-5 py-5 md:px-6">
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] xl:items-center">
        <div className="flex min-w-0 items-center gap-3">
          <div
            className="flex shrink-0 items-center justify-center overflow-hidden rounded-[20px] border border-border bg-surface-sunken p-2 transition-colors duration-200"
          >
            <img
              alt="Logo EduGuard"
