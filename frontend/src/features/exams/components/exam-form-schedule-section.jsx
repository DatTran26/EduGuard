    ...
    <section className="space-y-4 rounded-[20px] border border-border bg-neutral p-5">
      <div className="space-y-1">
        ...
        <p className="text-sm leading-6 text-secondary">
          Theo giờ Việt Nam (UTC+7). Frontend hiển thị theo múi giờ Việt Nam và gửi backend dưới dạng
          UTC để tránh lệch giờ giữa các máy.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <TextInput
          ...
          helperText="Thời lượng này được dùng để tính mốc đóng đề tự động khi bạn đã nhập giờ mở đề."
          min="1"
        ...
        <TextInput
          ...
          helperText="Theo giờ Việt Nam (UTC+7)."
