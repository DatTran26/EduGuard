    ...
    <section className="space-y-4 rounded-[20px] border border-border bg-neutral p-5">
      <div className="space-y-1">
        ...
        {showDescriptions ? (
          <p className="text-sm leading-6 text-secondary">
            Các tuỳ chọn này hỗ trợ anti-cheat và trải nghiệm làm bài trong môi trường thi trực
            tuyến.
          </p>
        ) : null}
      </div>
      ...
      {showDescriptions ? (
        <div className="rounded-[12px] border border-border bg-surface px-4 py-4 text-sm leading-6 text-secondary">
          Khi bật anti-cheat, giáo viên có thể theo dõi log vi phạm và điểm nghi ngờ ngay trên màn
          chi tiết đề thi. Fullscreen giúp giảm chuyển ngữ cảnh trong lúc làm bài.
        </div>
      ) : null}
    </section>
  );
