...
{
    /// <inheritdoc />
    public partial class AddAssignmentsExamsAndAttempts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableAntiCheat = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowResultAfterSubmit = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuspicionPoint = table.Column<int>(type: "int", nullable: false),
                    Metadata = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    OccurredAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheatingLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheatingLogs_ExamAttempts_ExamAttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheatingLogs_ExamAttemptId",
                table: "CheatingLogs",
                column: "ExamAttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_CheatingLogs_OccurredAt",
                table: "CheatingLogs",
                column: "OccurredAt");
