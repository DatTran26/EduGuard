...
2. **Mỗi giai đoạn:** backend API → test Swagger → frontend UI → test end-to-end. Trước khi code UI: đọc `docs/design/design-guidelines.md` và `design.md` (root).
...
| Feature hoàn chỉnh | `docs/changelog/project-changelog.md` |
...
| `docs/api/swagger-api-testing-guide.md` | Hướng dẫn test API trên Swagger (JWT, luồng E2E) |
| `AGENTS.md` | Chính sách Git, Husky, changelog — entry point cho agent |
| `docs/changelog/project-changelog.md` | Lịch sử chi tiết theo feature |
