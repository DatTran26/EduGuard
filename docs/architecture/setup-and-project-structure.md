...
│   ├── README.md
│   ├── project-overview.md
│   ├── setup-and-project-structure.md
│   └── ...
│
├── docker-compose.yml
├── README.md
...
SignalR (`AddSignalR`, `MapHub`) — Giai đoạn 8; đăng ký service trong `AddInfrastructure`, `MapHub` trong `Program.cs` — xem `docs/architecture/backend-architecture.md` §6–7.
