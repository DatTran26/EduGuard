...
**`Program.cs` chỉ giữ:** `AddInfrastructure`, CORS, Swagger, và pipeline `UseAuthentication()` / `UseAuthorization()` — xem `docs/architecture/setup-and-project-structure.md` §7.2.

Chi tiết setup: `docs/architecture/setup-and-project-structure.md` §7.1.
