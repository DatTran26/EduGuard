...
> Danh sách đầy đủ endpoint + checkbox triển khai: [`../api/api-list.md`](../api/api-list.md)
...
**Hướng dẫn chi tiết:** [`../api/swagger-api-testing-guide.md`](../api/swagger-api-testing-guide.md) — đăng nhập JWT, gán role Teacher, luồng Classroom → Assignment → Exam → Attempt.
