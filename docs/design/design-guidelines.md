...
| Lỗi API | Toast + `message` từ API (`docs/architecture/api-frontend-integration.md` §4) |
...
| `setup-and-project-structure.md` §8 | Cấu trúc folder frontend |
| `api-frontend-integration.md` §4 | Response/error shape cho toast |
| `project-overview.md` §4–6 | Vai trò user, module |
...
Ghi ngắn trong `docs/changelog/project-changelog.md` (nhóm Frontend / Design System).
