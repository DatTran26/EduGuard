...
## Documentation: Restructure docs/ and kebab-case filenames
...
- Feature or fix name: Documentation folder restructure + filename standardization.
- Purpose and user/business impact: Easier navigation — docs grouped by topic; consistent kebab-case names replace mixed `SCREAMING_SNAKE`, numbered prefixes, and camelCase (e.g. `HUONG_DAN_CHAY_HE_THONG.md` → `guides/system-run-guide.md`, `apiList.md` → `api/api-list.md`).
- Files or modules changed: All files under `docs/` (moved + renamed), `docs/README.md`, `README.md`, `AGENTS.md`, `Todo List.md`, `backend/README.md`, `frontend/README.md`, `design.md`, `.agents/skills/*.md`, internal cross-links, `CHANGELOG.md`, `docs/changelog/project-changelog.md`.
- Technical summary: `git mv` into topic folders; rename to kebab-case; bulk-update active references across repo; historical changelog entries keep original paths.
- Validation: Grep for stale `docs/07_`, `PROCTORING_`, `apiList`, `HUONG_DAN` in active workflow files.
- Known risks: External bookmarks may point to old paths or filenames.
...
- Files or modules changed: `docs/guides/system-run-guide.md`, `docs/proctoring/proctoring-network-modes.md`, `docs/README.md`, `CHANGELOG.md`.
- Technical summary: Consolidated run instructions; added per-script firewall table; merged hybrid tunnel steps 2–3 into single Admin `use-tunnel.cmd` flow; comparison table column for auto firewall in `proctoring-network-modes.md`.
...
- Files or modules changed: `docs/proctoring/proctoring-network-modes.md`, `frontend/.env`, `backend/EduGuard.Api/.env`, `docs/proctoring/proctoring-sfu-setup.md`, `.env.example`.
...
- Files or modules changed: `infra/livekit/docker-compose.yml`, `.env.example`, `backend/EduGuard.Api/.env`, `livekitRtcConfig.js`, SFU hooks, `docs/proctoring/proctoring-sfu-setup.md`.
...
- RC deploy target: local tunnel vs cloud — confirm LiveKit stack per `docs/proctoring/proctoring-sfu-setup.md`.
...
- Files or modules changed: `AppRoutes.jsx`, `routeConfig.js`, `ProctoringRoomLink.jsx`, `proctoringRouting.js`, `dev-login-accounts.md`, `proctoring-sfu-setup.md`, changelogs.
...
- `frontend/src/features/proctoring/utils/proctoringRouting.js`
- `docs/guides/dev-login-accounts.md`
- `docs/proctoring/proctoring-sfu-setup.md`
...
- Added `QuestionBank` and `ExamMatrix` Swagger operation tags and documented the `API-QBK-*` / `API-MTX-*` endpoints in `docs/api/api-list.md`.
...
- `docs/proctoring/proctoring-devb-integration.md`
...
- Merge/rebase onto `devD` / `devB` per `docs/proctoring/proctoring-devb-integration.md`.
...
- `backend/EduGuard.Infrastructure/Exams/question-import-parser.cs`
- `docs/question-bank/question-bank-import-templates.md`
- `docs/question-bank/question-import-template-usage.md`
...
- ─Éß╗ông bß╗Ö lß║íi khu vß╗▒c Teacher vß╗¢i `docs/design/ui-tech.md` ß╗ƒ c├íc lß╗çch lß╗¢n nhß║Ñt cß╗ºa frontend: ─æiß╗üu h╞░ß╗¢ng thiß║┐u mß╗Ñc, top bar ch╞░a c├│ search/quick-create, classroom detail ch╞░a c├│ tab nghiß╗çp vß╗Ñ, v├á ch╞░a c├│ c├íc page teacher ri├¬ng cho b├ái tß║¡p, gi├ím s├ít thi, kß║┐t quß║ú, th├┤ng b├ío.
...
- Added the teacher usage guide as `docs/question-bank/question-import-template-usage.md`, plus the provided DOCX/PDF guide files with no-accent names, and refreshed `docs/question-bank/question-bank-import-templates.md` to match the new standard.
...
- Copied `EduGuard_Import_Templates_4x5_Index.md` into `docs/question-bank/question-bank-import-templates.md` as the canonical template guide.
...
- `backend/EduGuard.Infrastructure/Exams/question-import-parser.cs`
- `docs/question-bank/question-bank-file-import-standard.md`
- `docs/features.md`
- `docs/api/api-list.md`
...
- `docs/project-changelog.md`, `docs/sql/assign-role-teacher.sql`, `.gitignore`
...
- `docs/architecture/database-entities.md`
...
- Chuyß╗ân c├íc m├án frontend lß╗¢p hß╗ìc v├á b├ái kiß╗âm tra tß╗½ `mockDatabase/localStorage` sang gß╗ìi backend thß║¡t qua `axiosClient`, b├ím theo c├íc endpoint ─æ├ú c├│ trong `docs/api/api-list.md`.
...
- `frontend/src/features/users/pages/UserManagementPage.jsx`
- `Todo List.md`
- `docs/architecture/api-frontend-integration.md`
- `docs/api/api-list.md`
- `docs/project-changelog.md`
...
- `docs/api/api-list.md`, `docs/swagger-api-testing-guide.md`, `Todo List.md`
...
- `docs/api/api-list.md`, `docs/swagger-api-testing-guide.md`
...
- Sß╗¡a URL Swagger c┼⌐ (`7234`) trong `api-frontend-integration.md` ΓåÆ `7168`.
- Li├¬n kß║┐t tß╗½ `api-list.md`, `development-rules.md`.
...
- `Todo List.md`, `docs/api/api-list.md`, `docs/project-changelog.md`
...
- Cß║¡p nhß║¡t `docs/architecture/setup-and-project-structure.md` ┬º7.2 (v├¡ dß╗Ñ ─æß║ºy ─æß╗º) v├á `docs/architecture/backend-architecture.md` ┬º6.

Changed files:

- `docs/architecture/setup-and-project-structure.md`
...
- ─Éß╗ông bß╗Ö `docs/architecture/setup-and-project-structure.md` vß╗¢i code Giai ─æoß║ín 1: `Program.cs` d├╣ng `AddInfrastructure`, t├ích mß╗Ñc hiß╗çn tß║íi (┬º7.1) vs mß╗Ñc ti├¬u Auth/JWT (┬º7.2).
...
- Cß║¡p nhß║¡t `docs/architecture/backend-architecture.md` ┬º6: ph├ón biß╗çt DI hiß╗çn tß║íi v├á ─æ─âng k├╜ repository/service t╞░╞íng lai.
...
- Cß║¡p nhß║¡t tiß║┐n ─æß╗Ö: `Todo List.md`, `README.md`, roadmap, `features.md`, `api-list.md`.
