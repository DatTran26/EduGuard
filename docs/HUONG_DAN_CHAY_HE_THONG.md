...
Tài khoản test: [`docs/DEV_LOGIN_ACCOUNTS.md`](DEV_LOGIN_ACCOUNTS.md) — mật khẩu chung `Test@12345`.
...
Chi tiết: [`docs/PROCTORING_SFU_SETUP.md`](PROCTORING_SFU_SETUP.md)
...
**Lưu ý:** Cần máy chủ chạy **cloudflared** (connector) và internet để tunnel hoạt động; traffic media vẫn ưu tiên LAN khi HS cùng Wi‑Fi. Chi tiết: [`docs/PROCTORING_NETWORK_MODES.md`](PROCTORING_NETWORK_MODES.md) mục 3.
...
Chi tiết: [`docs/PROCTORING_NETWORK_MODES.md`](PROCTORING_NETWORK_MODES.md)
...
Chi tiết E2E: [`docs/dev-test-proctoring-e2e.md`](dev-test-proctoring-e2e.md)
...
Checklist đầy đủ hơn: [`docs/LOCAL_DEV_SETUP_CHECKLIST.md`](LOCAL_DEV_SETUP_CHECKLIST.md)
...
| [`LOCAL_DEV_SETUP_CHECKLIST.md`](LOCAL_DEV_SETUP_CHECKLIST.md) | Checklist setup máy mới |
| [`PROCTORING_SFU_SETUP.md`](PROCTORING_SFU_SETUP.md) | LiveKit SFU chi tiết |
| [`PROCTORING_NETWORK_MODES.md`](PROCTORING_NETWORK_MODES.md) | LAN / Tailscale / Tunnel |
| [`DEV_LOGIN_ACCOUNTS.md`](DEV_LOGIN_ACCOUNTS.md) | Tài khoản test |
| [`dev-test-proctoring-e2e.md`](dev-test-proctoring-e2e.md) | Test E2E proctoring |
| [`02_SETUP_AND_PROJECT_STRUCTURE.md`](02_SETUP_AND_PROJECT_STRUCTURE.md) | Cấu trúc dự án |
| [`08_DEPLOY_WORKFLOW.md`](08_DEPLOY_WORKFLOW.md) | Deploy staging/production |
