...
> Cập nhật: 2026-06-15 · Tham chiếu: `docs/api/api-list.md`, `docs/api/features.md`  
...
- [`../../api/api-list.md`](../../api/api-list.md)
- [`../../api/swagger-api-testing-guide.md`](../../api/swagger-api-testing-guide.md)
