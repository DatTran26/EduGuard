# EduGuard — Danh sách API (api-list)

> **Mục đích:** Registry toàn bộ REST endpoint + SignalR hub — tick khi đã implement và test.  
> **Liên quan:** [`../architecture/api-frontend-integration.md`](../architecture/api-frontend-integration.md) (Axios, JWT, luồng FE) · [`swagger-api-testing-guide.md`](swagger-api-testing-guide.md) · [`features.md`](features.md) · [`../../Todo List.md`](../../Todo%20List.md)  
...
Frontend `.env`: `VITE_API_BASE_URL`, `VITE_SIGNALR_URL` — xem `api-frontend-integration.md`.
