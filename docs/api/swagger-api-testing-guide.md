...
> **Liên quan:** [`api-list.md`](api-list.md) · [`../architecture/api-frontend-integration.md`](../architecture/api-frontend-integration.md) · [`../architecture/setup-and-project-structure.md`](../architecture/setup-and-project-structure.md)  
...
Đối chiếu từng endpoint với tick list trong [`api-list.md`](api-list.md).
...
| File | Nội dung |
|------|----------|
| [`api-list.md`](api-list.md) | Danh sách 57 endpoint + tick tiến độ |
| [`../architecture/api-frontend-integration.md`](../architecture/api-frontend-integration.md) | Axios, JWT, luồng FE |
| [`../architecture/setup-and-project-structure.md`](../architecture/setup-and-project-structure.md) | Cài đặt solution, CORS |
| [`../development/development-rules.md`](../development/development-rules.md) | Quy tắc: test Swagger trước khi làm UI |
