...
> **Liên quan:** [`../../Todo List.md`](../../Todo%20List.md) · [`../development/development-roadmap.md`](../development/development-roadmap.md) · [`../architecture/api-frontend-integration.md`](../architecture/api-frontend-integration.md) · [`api-list.md`](api-list.md)  
...
Tick checkbox khi feature **đã chạy được end-to-end** (hoặc đủ tiêu chí module tương ứng). API REST map với ID trong [`api-list.md`](api-list.md).
