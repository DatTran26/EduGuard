...
Chi tiết tài khoản: [`docs/DEV_LOGIN_ACCOUNTS.md`](DEV_LOGIN_ACCOUNTS.md) — mật khẩu chung `Test@12345`.
...
7. Khác mạng → cần TURN (xem [`docs/proctoring-webrtc-nat.md`](proctoring-webrtc-nat.md))
...
- Đúng email/password: xem [`DEV_LOGIN_ACCOUNTS.md`](DEV_LOGIN_ACCOUNTS.md)
...
| [`proctoring-webrtc-nat.md`](proctoring-webrtc-nat.md) | STUN/TURN |
| [`dev-test-proctoring-e2e.md`](dev-test-proctoring-e2e.md) | Test E2E proctoring |
| [`02_SETUP_AND_PROJECT_STRUCTURE.md`](02_SETUP_AND_PROJECT_STRUCTURE.md) | Setup tổng quát |
