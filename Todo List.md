...
**Cập nhật:** 2026-06-25 (`release` @ `b1258dc` — PR #21 merged; `devD`/`devH`/`devB`/`feat` đã sync `origin/release`)
**Ghi chú devH:** 2026-06-25 (notifications + UI redesign đã merge `release` qua PR #21; `devH` fast-forward tới `b1258dc`)
...
- [x] Merge / rebase lên `devD` hoặc `release` (tránh conflict devB question bank) — `devD` @ `b735300`, các nhánh dev khác @ `b1258dc`
