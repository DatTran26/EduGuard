...
**Cập nhật:** 2026-06-25 (branch `feat/live-proctoring-control-room`: Live Proctoring Control Room v1 — backend entities/API/SignalR/WebRTC, student lobby+camera, teacher control room, evidence upload, YOLO proxy, admin AI settings, tile live preview, manual clip, CheatingLog cho camera off + AI detect; còn E2E WebRTC thật, cài Ultralytics production, responsive polish, merge devB/devD)
