...
**Cập nhật:** 2026-06-25 (devH: thiết kế lại trang Student `Bài tập / Bài thi` theo hướng card grid gọn hơn; tách hiển thị bài tập và bài thi theo segmented tab rõ ràng, thêm toolbar lọc đơn giản theo lớp/tên/trạng thái sẵn có, giữ nguyên API/routing hiện tại và đổi breadcrumb Student sang `Trang chủ > Bài kiểm tra`.)
